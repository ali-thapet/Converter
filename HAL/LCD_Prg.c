...
void LCD_WriteNumber_s32(s32 num)
{ 
	c8 str[10]={0},i;
...
void LCD_WriteBinary_u8(u8 num)
{ 
  s8 i;
  LCD_WriteString("0b");
  for(i=7;i>=0;i--)
...
void LCD_WriteBinary2_s32(s32 num)
{
	s8 i;
	LCD_WriteString("0b");
	for(i=15;i>=0;i--)
...
void LCD_WriteHex2_s16(s16 num)
{
	u8 FHN=num>>12;
	u8 FLN=(num>>8)&0x0f;
...
void LCD_WriteHex2_u16(u16 num)
{
	u8 FHN=num>>12;
	u8 FLN=(num>>8)&0x0f;
...
void LCD_WriteHex3_s32(s32 num)
{
	u8 HN1=num>>28;
	u8 LN1=(num>>24)&0x0f;
